...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 12 2021 г., 17:01
...
(2, '2020_07_21_103343_create_rooms', 1),
(3, '2020_07_22_121716_create_reservations', 1);
...
INSERT INTO `reservations` (`id`, `name`, `phone`, `room_id`, `reservation_date`, `days`) VALUES
(2, 'Marat', '+37477740723', 2, '18 January, 2021', 2);
...
CREATE TABLE `rooms` (
  ...
  `reservation_date` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `rooms` (`id`, `name`, `price`, `reservation_date`, `reserved`) VALUES
(1, '2', 8000, '18 January, 2021', 0),
(2, '3', 12000, '', 0),
(3, '4', 15000, '', 1),
(4, '5', 20000, '', 0);
